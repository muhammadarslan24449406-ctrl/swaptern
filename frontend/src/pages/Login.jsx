...
function Login() {
    ...
    const handleLogin = async () => {
        try {
            const res = await axios.post('https://swaptern-production.up.railway.app/api/auth/login', { email, password })
        ...
        <div className="min-h-screen flex">
            ...
            <div className="w-full md:w-1/2 flex flex-col justify-center px-8 md:px-16 py-12">
                ...
                <div className="flex bg-gray-100 rounded-lg p-1 mb-8">
                    <button className="flex-1 py-2 rounded-md bg-white text-gray-800 font-medium text-sm shadow-sm">Log In</button>
                    <Link to="/register" className="flex-1 py-2 rounded-md text-gray-500 font-medium text-sm text-center hover:text-gray-700">Sign Up</Link>
                </div>
